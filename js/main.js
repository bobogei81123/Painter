...
var ColorInput, Layer, Main, MountPoint, PencilTool, RangeInput, ShapeTools, Tools, UndoOp, circleTool, downloadTool, lineTool, main, paintTool, rectSelectTool, rectTool, sprayTool, undoTool,
...
Main = (function() {
  ...
  Main.prototype.changeCurrentTool = function(idx) {
    ...
    if (this.currentTool >= 0 && (this.tools[this.currentTool].onEnd != null)) {
      this.tools[this.currentTool].onEnd(this.activeLayer);
    }
  ...
  Main.prototype.downLayer = function() {
    ...
    return Layer.swap(depthArr[cid], depthArr[cid + 1]);
  };
...
Layer = (function() {
  ...
  Layer.prototype.renderPannel = function(idx) {
    ...
    console.log(this.prevCan.width());
    this.prevCan[0].width = this.prevCan.width();
    this.prevCan[0].height = this.prevCan.height();
    console.log(this.prevCan[0]);
  ...
  Layer.prototype.makePrev = function() {
    console.log(window.a = this.prevCan[0]);
    return this.prevCan[0].getContext('2d').drawImage(this.canvas, 0, 0, this.prevCan.width(), this.prevCan.height());
  };
...
paintTool = new Tools({
  ...
  onMouseDown: function(x, y, l) {
    ...
    return l.ctx.putImageData(rawData, 0, 0);
  },
...
main.tools = [new PencilTool, paintTool, rectTool, circleTool, lineTool, rectSelectTool, sprayTool, undoTool, downloadTool];
