...
var ColorInput, Main, MountPoint, RangeInput, Tools, circleTool, lineTool, main, paintTool, pencilTool, rectSelectTool, rectTool, sprayTool, undoTool,
...
lineTool = new Tools({
  ...
  onMouseDown: function(x, y, ctx, bctx) {
    var m;
    if (!this.hasLine) {
      this.getMount(0).setxy(x, y);
      return this.getMount(1).setxy(x, y);
    } else {
...
rectSelectTool = new Tools({
  ...
  onMouseUp: function(x, y, ctx, bctx) {
    ...
    if (!this.selected) {
      ...
      this.selected = true;
      _ref = [this.startSelectx, this.startSelecty], this.curx = _ref[0], this.cury = _ref[1];
      return console.log(this.curx, this.cury);
    } else if (this.drag) {
      return this.drag = false;
    }
  },
...
main.tools = [pencilTool, paintTool, rectTool, circleTool, lineTool, rectSelectTool, sprayTool, undoTool];
