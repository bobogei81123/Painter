...
var ColorInput, Layer, Main, MountPoint, RangeInput, ShapeTools, Tools, circleTool, downloadTool, lineTool, main, paintTool, pencilTool, rectSelectTool, rectTool, sprayTool, undoTool,
...
Main = (function() {
  ...
  Main.prototype.onMouseDown = function(e) {
    ...
    if (this.currentTool !== -1) {
      this.tools[this.currentTool].onMouseDown(x, y, this.layers[this.activeLayer]);
    }
  };
  ...
  Main.prototype.onMouseUp = function(e) {
    this.mouseUp();
    if (this.currentTool !== -1) {
      this.tools[this.currentTool].onMouseUp(e.offsetX - this.BufDis, e.offsetY - this.BufDis, this.layers[this.activeLayer]);
    }
  };
  ...
  Main.prototype.onMouseMove = function(e) {
    ...
    if (this.currentTool !== -1) {
      this.tools[this.currentTool].onMouseMove(x, y, this.layers[this.activeLayer], this.mouseStatus);
    }
    if (x < 0 || x >= this.width || y < 0 || y >= this.height) {
      this.mouseUp();
    }
