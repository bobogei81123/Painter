...
var ColorInput, Main, RangeInput, Tools, circleTool, lineTool, main, paintTool, pencilTool, rectSelectTool, rectTool, sprayTool,
...
lineTool = new Tools({
  ...
  onMouseMove: function(x, y, ctx, bctx, st) {
    ...
    bctx.beginPath();
    bctx.strokeStyle = this.controlVals[0].val().toRgbString();
    bctx.lineWidth = parseInt(this.getVal(1));
    bctx.moveTo(this.startx, this.starty);
    bctx.lineTo(this.endx, this.endy);
    return bctx.stroke();
  },
  onMouseUp: function(x, y, ctx, bctx) {
    bctx.clearAll();
